...
public class Framework extends Canvas {
   ...
   /**
    ...
    private void LoadContent()
    {
        try
        {
            URL moonLanderMenuImgUrl = this.getClass().getResource("/DragonPoopGame/resources/images/menu.jpg");
    ...
    private void GameLoop()
    {
        ...
        while(true)
        {
            ...
            switch (gameState)
            {
                ...
                break;
                case VISUALIZING:
                    // On Ubuntu OS (when I tested on my old computer) this.getWidth() method doesn't return the correct value immediately (eg. for frame that should be 800px width, returns 0 then 790 and at last 798px).
            ...
            // Here we calculate the time that defines for how long we should put the thread to sleep to meet the GAME_FPS.
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case MAIN_MENU:
                ...
                g2d.drawString("Use WASD or arrow keys to control the rocket.", frameWidth / 2 - 117, frameHeight / 2);
